...
submitButton.addEventListener("click", () => {
  if (
    !/[0-9]/.test(nombreTarjeta.value) &&
    nombreTarjeta !== "" &&
    /[0-9]/.test(cardNumberInp.value) &&
    cardNumberInp.value.length == 16 &&
    /[0-9]/.test(monthInp.value) &&
    monthInp.value.length == 2 &&
    !/[A-Za-z]/.test(yearInp.value) &&
    monthInp.value.length == 2 &&
    !/[A-Za-z]/.test(yearInp.value) &&
    monthInp.value.length == 2
  ) {
